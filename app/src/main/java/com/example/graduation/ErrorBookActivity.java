...
import com.example.graduation.fragment.CheckBookErrorFragment;
import com.example.graduation.fragment.CheckHistoryFragment;
import com.example.graduation.fragment.ParcitceBookErrorFragment;
...
public class ErrorBookActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView(){
        imageBack = findViewById(R.id.errorbook_image_back);
        textCheck = findViewById(R.id.errorbook_text_check);
        textParcity = findViewById(R.id.errorbook_text_parcitice);
        viewCheck = findViewById(R.id.errorbook_view_check);
        viewParcity = findViewById(R.id.errorbook_view_parcitice);
        viewPager = findViewById(R.id.errorbook_viewpager);
    ...
    private void initDatas(){
        ...
        mFragments.add(new CheckBookErrorFragment());
        mFragments.add(new ParcitceBookErrorFragment());
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.errorbook_image_back:
                finish();
                break;
            case R.id.errorbook_text_check:
                selectTab(0);
                break;
            case R.id.errorbook_text_parcitice:
                selectTab(1);
                break;
        }
    }
